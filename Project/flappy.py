...
game_image = {}
game_audio_sound = {}
player = 'C:/Users/hello/Downloads/Flappy-Birds-Game/images/bird.png'
bcg_image = 'C:/Users/hello/Downloads/Flappy-Birds-Game/images/background.png'
pipe_image = 'C:/Users/hello/Downloads/Flappy-Birds-Game/images/pipe.png'
...
if __name__ == "__main__":
    ...
    game_image['numbers'] = (
        pygame.image.load('C:/Users/hello/Downloads/Flappy-Birds-Game/images/0.png').convert_alpha(),
        pygame.image.load('C:/Users/hello/Downloads/Flappy-Birds-Game/images/1.png').convert_alpha(),
        pygame.image.load('C:/Users/hello/Downloads/Flappy-Birds-Game/images/2.png').convert_alpha(),
        pygame.image.load('C:/Users/hello/Downloads/Flappy-Birds-Game/images/3.png').convert_alpha(),
        pygame.image.load('C:/Users/hello/Downloads/Flappy-Birds-Game/images/4.png').convert_alpha(),
        pygame.image.load('C:/Users/hello/Downloads/Flappy-Birds-Game/images/5.png').convert_alpha(),
        pygame.image.load('C:/Users/hello/Downloads/Flappy-Birds-Game/images/6.png').convert_alpha(),
        pygame.image.load('C:/Users/hello/Downloads/Flappy-Birds-Game/images/7.png').convert_alpha(),
        pygame.image.load('C:/Users/hello/Downloads/Flappy-Birds-Game/images/8.png').convert_alpha(),
        pygame.image.load('C:/Users/hello/Downloads/Flappy-Birds-Game/images/9.png').convert_alpha(),
    )

    game_image['message'] = pygame.image.load('C:/Users/hello/Downloads/Flappy-Birds-Game/images/message.png').convert_alpha()
    game_image['base'] = pygame.image.load('C:/Users/hello/Downloads/Flappy-Birds-Game/images/base.png').convert_alpha()
    ...
    # Game sounds
    game_audio_sound['die'] = pygame.mixer.Sound('C:/Users/hello/Downloads/Flappy-Birds-Game/sounds/die.wav')
    game_audio_sound['hit'] = pygame.mixer.Sound('C:/Users/hello/Downloads/Flappy-Birds-Game/sounds/hit.wav')
    game_audio_sound['point'] = pygame.mixer.Sound('C:/Users/hello/Downloads/Flappy-Birds-Game/sounds/point.wav')
    game_audio_sound['swoosh'] = pygame.mixer.Sound('C:/Users/hello/Downloads/Flappy-Birds-Game/sounds/swoosh.wav')
    game_audio_sound['wing'] = pygame.mixer.Sound('C:/Users/hello/Downloads/Flappy-Birds-Game/sounds/wing.wav')
